...
VALUES
    (46, 'Robbery', '2024-04-01', 40.7128, -74.0060, 'Robbery in Vijayawada market, cash stolen, suspect at large.', 'Open', 16, 1, 31),
    (47, 'Homicide', '2024-04-05', 34.0522, -118.2437, 'Homicide in Visakhapatnam, victim identified, suspect arrested.', 'Closed', 17, 2, 32),
    (48, 'Theft', '2024-04-10', 51.5074, -0.1278, 'Theft in Tirupati temple, stolen artifacts recovered, suspect apprehended.', 'Open', 18, 3, 33),
    (49, 'Assault', '2024-04-15', 41.8781, -87.6298, 'Assault in Guntur mall, minor injuries reported, suspect detained.', 'Closed', 19, 4, 34),
    (50, 'Burglary', '2024-04-20', 39.9526, -75.1652, 'Burglary in Kurnool residence, valuables stolen, suspect identified.', 'Closed', 20, 5, 35),
    (51, 'Robbery', '2024-04-25', 33.4484, -112.0740, 'Robbery in Rajahmundry bank, cash and jewelry stolen, suspect on run.', 'Open', 21, 3, 36),
    (52, 'Homicide', '2024-04-30', 37.7749, -122.4194, 'Homicide in Nellore alley, victim unknown, investigation ongoing.', 'Open', 22, 2, 37),
    (53, 'Theft', '2024-05-05', 34.0522, -118.2437, 'Theft in Kakinada museum, stolen artifacts recovered, suspect in custody.', 'Closed', 23, 1, 38),
    (54, 'Assault', '2024-05-10', 41.8781, -87.6298, 'Assault in Anantapur restaurant, victim hospitalized, suspect fled.', 'Open', 24, 5, 39),
    (55, 'Burglary', '2024-05-15', 40.7128, -74.0060, 'Burglary in Eluru jewelry store, valuables missing, suspect at large.', 'Closed', 25, 2, 40),
    (56, 'Robbery', '2024-05-20', 34.0522, -118.2437, 'Robbery in Vizianagaram market, cash and electronics stolen, suspect identified.', 'Open', 26, 3, 41),
    (57, 'Homicide', '2024-05-25', 37.7749, -122.4194, 'Homicide in Ongole neighborhood, victim shot, suspect unknown.', 'Open', 27, 4, 42),
    (58, 'Theft', '2024-05-30', 33.4484, -112.0740, 'Theft in Tenali supermarket, stolen goods recovered, suspect apprehended.', 'Closed', 28, 5, 43),
    (59, 'Assault', '2024-06-05', 39.9526, -75.1652, 'Assault in Srikakulam park, minor injuries reported, suspect at large.', 'Open', 29, 1, 44),
    (60, 'Burglary', '2024-06-10', 41.8781, -87.6298, 'Burglary in Kurnool pharmacy, drugs stolen, suspect identified.', 'Open', 30, 2, 45);
